  ...
  <div className="body">
    ...
    <div className="content">
      <h2>Here is the Attachment for: &nbsp;
        <Link
        href="/attachments/IICTDS_2025_NMIMS_CHD__2_Day_schedule_fin.pdf"
      ...
      <h2>Here is the Attachment for: &nbsp;
        <Link
        href="/attachments/IICTDS_2025_NMIMS_CHD_Presentation_Schedule_final_schedule_updated_8.pdf"
        className="schedule-link">
